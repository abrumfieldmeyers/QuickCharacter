...
class CharBack:
    def __init__(self, name, skill_prof=[], tool_prof=[], weapon_prof=[], armor_prof=[], languages=[], weapons=[], armor=[], equipment={}, feature=Features()):
        self.name = name
        ...
        self.feature = Features(feature.name,feature.text,"background")
...
BackList = {
    "Acolyte": CharBack(
        ...
        feature= Features("Shelter of the Faithful", 'As an acolyte, you command the respect of those who share your faith, and '
    ...
    "Charlatan": CharBack(
        ...
        feature=Features('False Identity', 'You have created a second identity that includes documentation, established '
    ...
    "Criminal": CharBack(
        ...
        feature= Features('Criminal Contact', 'You have a reliable and trustworthy contact who acts as your liaison to a network'
    ...
    "Entertainer": CharBack(
        ...
        feature= Features('By Popular Demand', 'You can always find a place to perform, usually in an inn or tavern but possibly'
    ...
    "Folk Hero": CharBack(
        ...
        feature=Features('Rustic Hospitality','Since you come from the ranks of the common folk, you fit in among them with '
    ...
    "Guild Artisan": CharBack(
        ...
        feature= Features('Guild Membership', 'As an established and respected member of a guild, you can rely on certain '
    ...
    "Hermit": CharBack(
        ...
        feature= Features('Discovery', 'The quiet seclusion of your extended hermitage gave you access to a unique and powerful '
    ...
    "Knight": CharBack(
        ...
        feature= Features('Retainers', 'You have the service of three retainers loyal to your family. These retainers can be '
    ...
    "Outlander": CharBack(
        ...
        feature= Features('Wanderer', 'You have an excellent memory for maps and geography, and you can always recall the '
    ...
    "Sage": CharBack(
        ...
        feature= Features('Researcher', 'When you attempt to learn or recall a piece of lore, if you do not know that '
    ...
    "Sailor": CharBack(
        ...
        weapons=["Club"],
        feature=Features('Ship\'s Passage', 'When you need to, you can secure free passage on a sailing ship for yourself and'
    ...
    "Soldier": CharBack(
        ...
        feature=Features('Military Rank', 'You have a military rank from your career as a soldier. Soldiers loyal to your '
                   'former'
    ...
    "Urchin": CharBack(
        ...
        weapons=["Dagger"],
        feature=Features('City Secrets', 'You know the secret patterns and flow to cities and can find passages through the '
