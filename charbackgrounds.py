bgds = {
    'Acolyte': {
        ...
        'feature': 'Shelter of the Faithful: As an acolyte, you command the respect of those who share your faith, and '
                   ...
                   'with your temple.',
        'personality_trait': ['I idolize a hero of my faith.',
                              'I can find common ground between the fiercest enemies.',
                              'I see omens in every event and action.',
                              'Nothing can shake my optimistic attitude.',
                              'I quote (or misquote) sacred texts and proverbs in every situation.',
                              'I am tolerant (or intolerant) of other faiths and respect (or condemn) all other '
                              'gods.',
                              'I\'ve enjoyed the fine food, drink, and high society among my temple\'s elite. Rough'
                              'living grates on me.',
                              'I\'ve spent so long in the temple that I have little practical experience in the '
                              'outside world.'],
        'ideal': ['Tradition: The ancient traditions of worship and sacrifice must be preserved and upheld.',
                  ...
                  'Faith: I trust that my deity will guide my actions. I have faith that if I work hard, '
                  'things will go well.',
    ...
    'Charlatan': {
        ...
        'question': ['Favorite Schemes:', ['I cheat at games of chance.',
                                           'I shave coins or forge documents.',
                                           'I insinuate myself into people\'s lives to prey on their weakness and '
                                           'secure their fortunes.',
                                           'I put on new identities like clothes.',
                                           'I run sleight-of-hand cons on street corners.',
                                           'I convince people that worthless junk is worth their hard-earned money.']],
        'personality_trait': ['I fall in and out of love easily, and am always pursuing someone.',
                              'I have a joke for every occasion, especially where humer is inappropriate.',
        ...
        'bond': ['I fleeced the wrong person and must work to ensure that this individual never crosses paths with me '
                 'or those I care about.',
                 'I owe everything to my mentor – a horrible person who\'s probably rotting in jail somewhere.',
                 'Somewhere out there, I have a child who doesn\'t know me. I\'m making the world better for him or '
                 'her.',
                 'I come from a noble family, and one day I\'ll reclaim my lands and title from those who stole them '
                 'from me.',
                 'A powerful person killed someone I love. Some day soon, I\'ll have my revenge.',
                 'I swindled and ruined a person who didn\'t deserve it. I seek to atone for my misdeeds but might '
    ...
    'Criminal': {
        ...
        'equipment': {
            ...
            'Gold': 15},
        'question': ['Criminal Specialty:',
                     ['Blackmailer', 'Burglar', 'Enforcer', 'Fence', 'Highway Robber', 'Hired Killer', 'Pickpocket',
                      'Smuggler']],
        ...
        'personality_trait': ['I always have a plan for what to do when things go wrong.',
                              'I am always calm, no matter what the situation. I never raise my voice or let my '
                              'emotions control me.',
        ...
        'ideal': ['Honor. I don\'t steal from others in the trade. (Lawful).',
                  ...
                  'People. I\'m loyal to my friends, not to any ideals, and everyone else can take a trip down the Styx'
                  ' for all I care. (Neutral)',
    ...
    'Entertainer': {
        ...
        'equipment': {
            ...
            'Costume': 1,
            'Gold': 15},
        'question': ['Entertainer Routines:', ['Actor', 'Dancer', 'Fire-eater', 'Jester', 'Juggler', 'Instrumentalist',
                                               'Poet', 'Singer',
                                               'Storyteller', 'Tumbler']],
        ...
        'personality_trait': ['I know a story relevant to almost every situation.',
    ...
    'Folk Hero': {
        ...
        'tool proficiencies': ['Artisans Tools', 'Vehicles (land)'],
        'weapon proficiencies': [],
        'armor proficiencies': [],
        'languages': [],
        'equipment': {
            ...
            'Common Clothes': 1,
            'Gold': 10},
        'question': ['Defining Event:', ['I stood up to a tyrant\'s agents.',
                                         'I saved people during a natural disaster.',
                                         'I stood alone against a terrible monster.',
                                         'I stole from a corrupt merchant to help the poor.',
                                         'I led a militia to fight off an invading army.',
                                         'I broke into a tyrant\'s castle and stole weapons to arm the people.',
                                         'I trained the peasantry to use farm implements as weapons against a tyrant\'s'
                                         ' soldiers.',
                                         'A lord rescinded an unpopular decree after I led a symbolic act of protect '
                                         'against it.',
                                         'A celestial, fey, or similar creature gave me a blessing or revealed my '
                                         'secret origin.',
                                         'Recruited into a lord\'s army, I rose to leadership and was commended for my '
                                         'heroism.']],
        ...
        'personality_trait': ['I judge people by their actions, not their words.',
    ...
    'Guild Artisan': {
        ...
        'tool proficiencies': ['Artisans Tools'],
        'weapon proficiencies': [],
        'armor proficiencies': [],
        'languages': ['any'],
        'equipment': {
            ...
            'Gold': 15},
        'question': ['Guild Business:', ['Alchemists and Apothecaries',
        ...
        'flaw': ['\'ll do anything to get my hands on something rare or priceless.',
                 'I\'m quick to assume that someone is trying to cheat me.',
                 'No one must ever learn that I once stole money from guild coffers.',
                 'I\'m never satisfied with what I have – I always want more.',
                 'I would kill to acquire a noble title.',
                 'I\'m horribly jealous of anyone who can outshine my handiwork. Everywhere I go, I\'m surrounded by '
                 'rivals.']
    },
    'Guild Merchant': {
        'skill proficiencies': ['Insight', 'Persuasion'],
    ...
    'Hermit': {
        ...
        'equipment': {
            ...
            'Herbalism Kit': 1,
            'Gold': 5},
        'question': ['Life of Seclusion:', ['I was searching for spiritual enlightenment.',
                                            'I was partaking of communal living in accordance with the dicates of a '
                                            'religious order.',
        ...
        'bond': ['Nothing is more important than the other members of my hermitage, order, or association.',
                 'I entered seclusion to hide from the ones who might still be hunting me. I must someday confront '
                 'them.',
    ...
    'Knight': {
        ...
        'personality_trait': [
            'My eloquent flattery makes everyone I talk to feel like the most wonderful and important person in the '
            'world.',
        ...
        'ideal': [
            'Respect. Respect is due to me because of my position, but all people regardless of station deserve to be '
            'treated with dignity. (Good)',
            'Responsibility. It is my duty to respect the authority of those above me, just as those below me must '
            'respect mine. (Lawful)',
    ...
    'Noble': {
        ...
        'equipment': {
            ...
            'Gold': 25},
        'question': [],
        'feature': 'Position of Privelege: Thanks to your noble birth, people are inclined to think the best of you. '
                   'You are welcome in high society, and people assume you have the right to be wherever you are. The '
                   'common folk make every effort to accommodate you and avoid your displeasure, and other people of '
                   'high birth treat you as a member of the same social sphere. You can secure an audience with a local'
    ...
    'Outlander': {
        ...
        'equipment': {
            ...
            'Gold': 10},
        'question': ['Origin:',
                     ['Forester', 'Trapper', 'Homesteader', 'Guide', 'Exile or Outcast', 'Bounty Hunter', 'Pilgrim',
        ...
        'feature': 'Wanderer: You have an excellent memory for maps and geography, and you can always recall the '
                   'general'
                   ' layout of terrain, settlements, and other features around you. In addition, you can find food and '
        ...
        'personality_trait': ['I\'m driven by a wanderlust that led me away from home.',
                              'I watch over my friends as if they were a litter of newborn pups.',
                              'I once ran twenty-five miles without stopping to warn my clan of an approaching orc '
    ...
    'Pirate': {
        ...
        'equipment': {
            ...
            'Gold': 10},
        'question': [],
        'feature': 'Bad Reputation: No matter where you go, people are afraid of you due to your reputation. When you '
                   'are in a civilized settlement, you can get away with minor criminal offenses, such as refusing to '
                   'pay for food at a tavern or breaking down doors at a local shop, since most people will not report '
                   'your activity to the authorities.',
        'personality_trait': ['My friends know they can rely on me, no matter what.',
        ...
        'bond': ['I\'m loyal to my captain first, everything else second.',
                 ...
                 'Ruthless pirates murdered my captain and crewmates, plundered our ship, and left me to die. Vengeance'
                 ' will be mine.'],
    ...
    'Sage': {
        ...
        'feature': 'Researcher: When you attempt to learn or recall a piece of lore, if you do not know that '
                   ...
                   'it '
                   'simply cannot be found. Unearthing the deepest secrets of the multiverse can require an adventure '
                   'or even a whole campaign.',
        'personality_trait': ['I use polysyllabic words that convey the impression of great erudition.',
    ...
    'Soldier': {
        ...
        'flaw': ['The monstrous enemy we faced in battle still leaves me quivering with fear.',
                 ...
                 'I made a terrible mistake in battle that cost many lives – and I would do anything to keep that'
                 ' mistake secret.',
    ...
    'Urchin': {
        ...
        'personality_trait': ['I hide scraps of food and trinkets away in my pockets.',
        ...
        'ideal': ['Respect. All people, rich or poor, deserve respect. (Good)',
                  ...
                  'Change. The low are lifted up, and the high and mighty are brought down. Change is the nature of'
                  ' things. (Chaotic)',
